...
M.storm = {
  ...
  border_accent  = "#8a6459", -- colored border = blend(orange, 0.5) over bg; swap accent to taste
  ...
  cyan           = "#7ac5e2", -- punctuation(.delimiter/.bracket/.list_marker)
  cyan2          = "#99d1db", -- operator, keyword.export, link_text.hover
